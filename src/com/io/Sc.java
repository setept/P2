...
public class Sc {
	...
	public static void main(String[] args) throws Exception {
		...
		for (String line : lines) {
			...
			for (int i = j * 10 + 1; i < j * 10 + 11; i++) {
				...
				if(i%10==3) {
					...
					rowi.createCell(4).setCellValue("李雪纯子/刘念念");
					rowi.createCell(5).setCellValue("2019/10/29");
					rowi.createCell(6).setCellValue("学院体育馆");
					rowi.createCell(7).setCellValue("");
					rowi.createCell(8).setCellValue("2");
				...
				if(i%10==0) {
					rowi.createCell(3).setCellValue("一分钟仰卧起做");
					rowi.createCell(4).setCellValue("毛声宇/样钰莹");
					rowi.createCell(5).setCellValue("2019/10/29");
					rowi.createCell(6).setCellValue("学院体育馆");
					rowi.createCell(7).setCellValue("");
					rowi.createCell(8).setCellValue("2");
		...
		FileOutputStream font = new FileOutputStream("d:\\测试模板.xls");
		wb.write(font);
		font.close();
	}
